...
export const Route = createFileRoute("/world-cup-2026")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Browse the full CHECKMATE World Cup 2026 player-edition catalogue. All jerseys ₹850 flat · Free all-India shipping · Order on WhatsApp." },
